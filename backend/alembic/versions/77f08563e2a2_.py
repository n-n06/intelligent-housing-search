...
Revision ID: 77f08563e2a2
Revises: 
Create Date: 2025-12-21 15:12:31.757077
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('city', 'latitude', 'longitude', name='uq_location_geo')
    )
    ...
    sa.Column('type', postgresql.ENUM('rent', 'sell', name='listing_type'), nullable=False),
